<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="低手昵称" width="160">
      ...
      <el-table-column label="低手账号" align="left" width="150">
        <template slot-scope="{row}">
          <span>{{ row.lower_hand_account_number }}</span>
        </template>
      </el-table-column>
      <el-table-column label="高手账号" align="left" width="150">
        <template slot-scope="{row}">
      ...
      <el-table-column label="跟单类型" width="100">
        <template slot-scope="{row}">
          <span>{{ row.documentary_type_display }}</span>
        </template>
      </el-table-column>
      <el-table-column label="跟单创建时间" width="150">
        <template slot-scope="{row}">
...
<script>
import { documentList } from "@/api/market";
