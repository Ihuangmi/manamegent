<template>
  <div class="app-container" style="height: 100%">
    ...
    >
      ...
      <el-table-column label="邀请码" prop="invite_code" sortable="custom" align="right" width="90">
        <template slot-scope="{row}">
      ...
      <el-table-column label="冻结钱包余额" prop="frost_wallet" width="130" align="right">
        <template slot-scope="{row}">
          <span>{{ row.frost_wallet }}</span>
        </template>
      </el-table-column>

      <el-table-column label="关联账户数量" width="110" align="right">
        <template slot-scope="{row}">
      ...
      <el-table-column label="注册时间" prop="date_joined" sortable="custom" width="150">
        <template slot-scope="{row}">
